...
from hibpcalc.ring import Ring, magneticFdOnRingCenter, magneticFdOfRing #, FilamentGroup
from hibpcalc.geomfunc import pt3D, vec3D, line_array
...
circle = g3.Circle3D(center=gx.point3D(0, 0, 0), radius=1.0, normal=g3.vector3D(0, 0, 1))
